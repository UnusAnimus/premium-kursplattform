...
export default function AdminSystemPage() {
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6">
      <div>
        <h1 className="text-3xl font-bold text-white mb-1">Systemeinstellungen</h1>
        <p className="text-slate-400">Allgemeine Konfiguration der Plattform.</p>
      </div>

      {/* General */}
      <div className="bg-[#13131a] border border-[#1e1e2e] rounded-xl p-6">
        <h2 className="text-lg font-semibold text-white mb-6">Allgemein</h2>
        <div className="space-y-4">
          {[
            ...
            <div key={field.key}>
              <label className="text-slate-300 text-sm font-medium block mb-2">{field.label}</label>
              <input
                type={field.type}
      ...
      {/* Access */}
      <div className="bg-[#13131a] border border-[#1e1e2e] rounded-xl p-6">
        <h2 className="text-lg font-semibold text-white mb-6">Zugriff & Registrierung</h2>
        <div className="space-y-4">
          {[
