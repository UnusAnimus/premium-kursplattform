      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <div className="inline-flex items-center gap-2 bg-violet-500/10 border border-violet-500/30 rounded-full px-4 py-2 mb-6">
            ...
            <span className="text-violet-400 text-sm font-medium">Warum Arkanum Akademie?</span>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {features.map((feature, i) => (
            <div
              key={i}
              className="bg-[var(--bg-surface)] border border-[var(--border-base)] rounded-xl p-6 hover:border-violet-500/50 transition-all duration-300 hover:-translate-y-1 group"
            >
              ...
              <h3 className="font-semibold text-[var(--text-primary)] text-lg mb-2">{feature.title}</h3>
